use crate::gamepad::{AnalogStick, Buttons, GamepadFieldUpdate, GamepadState};
use crate::input::InputError;

/// Maximum line length for the protocol (including newline).
pub const MAX_LINE_LENGTH: usize = 64;

/// Minimum valid full state message length: G0000:0:0:0:0:0:0*XX = 22 chars
const MIN_FULL_STATE_LEN: usize = 22;
