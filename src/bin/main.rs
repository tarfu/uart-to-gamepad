...
use uart_to_gamepad::gamepad::GamepadState;
use uart_to_gamepad::input::{InputSource, UartInputSource};
use uart_to_gamepad::output::usb_hid::configure_usb_hid;
use uart_to_gamepad::output::{OutputSink, UsbHidOutput};
